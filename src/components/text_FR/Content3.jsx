import '../../styles/about/content3.css'
            ...
            <div className="content3">
                <div className="content3__container">
                  ...
                  <ul className="content3__container__list">
                    ...
                    <li className="content3__container__list__item testX" id="content3_4">Organisation des équipes, sécurité, commande de matériaux, réunions client et assurer la qualité des ouvrages</li>
                  </ul>
                </div>
            </div>
    )
