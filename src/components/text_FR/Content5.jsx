            ...
            <div className="content5">
                <div className="content5__container">
                  ...
                  <ul className="content5__container__list">
                    ...
                    <li className="content5__container__list__item" id="content5_2">Accompagné par de talentueux Data Scientist, je me suis spécialisé et j'ai gagné en indépendance.</li>
